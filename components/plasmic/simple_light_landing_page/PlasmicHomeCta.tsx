...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: ioydRJWlLSlsf/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: _FX4r1CnC-QTUm/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pGrdY)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__je0Qr)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__gvJmM)}>
          <SphereIcon
