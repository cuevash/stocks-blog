...
import sty from "./PlasmicAvatar.module.css"; // plasmic-import: ojLA9DXhzPv2Sq/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img___5TtO1)}
            ...
            src={{
              src: "https://img.plasmic.app/img-optimizer/v1/img/086a7899888a1576f59851762dab3447.png",
              fullWidth: 192,
              fullHeight: 192
            }}
          />
