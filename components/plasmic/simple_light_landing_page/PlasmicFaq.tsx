...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: UOgKLTtsvBIkA7/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__uCoe6)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__qCJj)}>
          <div className={classNames(projectcss.all, sty.freeBox__sg4Qu)}>
            {p.renderPlasmicSlot({
